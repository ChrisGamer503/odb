    ...
    return (
      <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center" onClick={closeModal}>
        ...
        <div className="bg-white p-6 w-[320px] md:w-[350px] lg:w-[500px] h-auto rounded-lg shadow-lg border-4 border-gray-700 flex flex-col items-center">
            <div ref={carnetRef} className="w-full p-4 border-2 border-black flex flex-col items-center space-y-2 relative mi-clase">
              ...
              <div className="w-full text-black border-b-2 pb-2 border-black">
                ...
                <p className="text-base">{esOrientador ? persona?.nombre_orientador : `${persona?.nombre1 || ""} ${persona?.nombre2 || ""} ${persona?.apellido1 || ""} ${persona?.apellido2 || ""} (${persona?.id_jugador || ""})`.trim()}</p>
              </div>
              ...
              <div className="w-full h-full flex justify-between items-center">
                <div className="w-2/5 text-center h-full">
                  <div className="text-sm text-black border-b-2 mt-10 border-black"></div>
                  <p>Jugador</p>
                </div>

                <div className="w-2/5 text-center h-full">
                  <div className="text-sm text-black border-b-2 border-black flex justify-center items-center">
                    <img src="../../public/img.png" alt="firma" className="h-[2.5rem] w-auto m-0" />
                  </div>
                  <p>E. de Oratorio</p>
                </div>
              </div>
