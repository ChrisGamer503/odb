    ...
    <div className="fixed inset-0 bg-gray-500 bg-opacity-50 flex justify-center items-center" onClick={closeModal}>
      ...
      <div className="bg-white p-6 w-[320px] md:w-[350px] lg:w-[500px] h-auto rounded-lg shadow-lg border-4 border-gray-700 flex flex-col items-center">
          <div ref={carnetRef} className="w-full p-4 border-2 border-black flex flex-col items-center space-y-2 relative mi-clase">
            <div className={`w-full h-[3%] top-0 left-0 absolute ${getCategoryColor(categoria?.nombre)}`}></div>
...
const getCategoryColor = (categoria) => {
  const categoryColors = {
    "Pony B": "bg-green-500",
    "Pony A": "bg-blue-500",
    "Infantil B": "bg-red-500",
    "Infantil A": "bg-purple-500",
    "Intermedia B": "bg-yellow-500",
    "Intermedia A": "bg-orange-500",
    "Juvenil B": "bg-lime-600",
    "Juvenil A": "bg-sky-400",
    "Femenina": "bg-violet-500",
  };

  return categoryColors[categoria] || "bg-gray-500"; // Color por defecto si no hay coincidencia
};